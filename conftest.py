...
#данные о переменных browser_name и language из командной строки. по умолчанию запускается браузер chrome на русском языке 
def pytest_addoption(parser):
    parser.addoption('--browser_name', action='store', default="chrome", help="Choose browser: chrome or firefox")
    parser.addoption('--language', action='store', default="ru", help ="Choose browser language: ru, en, fr...")
